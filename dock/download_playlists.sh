...
# Variables
ARCHIVE_FILE="/archive/archive_playlists.txt"
OUTPUT_DIR="/data/%(playlist_title)s/%(title)s.%(ext)s"
URLS_FILE="/config/urls_playlists.txt"

echo ""
echo ""
echo "[$(date '+%Y-%m-%d %H:%M:%S')] Scan des playlists..."
echo ""
echo ""
